      ...
      <div className="grid items-center gap-10 md:grid-cols-[18rem_1fr]">
        ...
        <div className="flex flex-col gap-4">
          <p className="text-lg leading-relaxed text-gray-200">
            Olá! Sou o{" "}
            <span className="font-semibold text-primary">Matheus Santos</span>,
            desenvolvedor FullStack apaixonado por construir experiências
            digitais que unem código limpo e um design cuidadoso.
          </p>
          <p className="leading-relaxed text-gray-400">
            Trabalho transformando ideias em produtos reais, sempre com foco em
            performance, acessibilidade e boa experiência do usuário. Estou
            sempre estudando e aplicando novas tecnologias para entregar o
